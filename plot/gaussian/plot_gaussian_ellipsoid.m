function h = plot_gaussian_ellipsoid(m, C, sdwidth,plotArgIn, npts, axh)
...
if ~exist('plotArgIn', 'var'), plotArgIn = {}; end
...
switch numel(m)
   case 2, h=show2d(m(:),C,sdwidth,plotArgIn,npts,axh);
   case 3, h=show3d(m(:),C,sdwidth,plotArgIn,npts,axh);
   otherwise
...
%-----------------------------
function h = show2d(means, C, sdwidth, plotArgIn,npts, axh)
...
h = plot(bp(1,:), bp(2,:), plotArgIn{:}, 'parent', axh);
